...
public class UserTest extends KinveyMockUnitTest {
    ...
    private final String xCustomProperties = "X-Kinvey-Custom-Request-Properties";
    private final String xAppVersion = "X-Kinvey-Client-App-Version";
    ...
    public void testUserCustomVersion() throws IOException {
    	...
    	Object header = request.getRequestHeaders().get(xAppVersion);
    ...
    public void testUserCustomHeader() throws IOException {
    	...
    	Retrieve request = requestManager.retrieveBlocking();
    	Object header = request.getRequestHeaders().get(xCustomProperties);
