 ...
 * @param builder
 */
(protected var builder: QueryFilterBuilder) : Serializable {

    protected var sort: LinkedHashMap<String, SortOrder> = LinkedHashMap()
     ...
     */
    val queryFilterMap: AbstractMap<String, Any>
                ...
                if (value == null) {
                    ...
                    if (valueClass == String::class.java) {
                        ...
                        if (valueClass.isArray) {
                            ...
                            generator.writeFieldName(key)
                            generator.writeStartArray()
                            val valueMap = value as Array<LinkedHashMap<String, Any>>
                            for (map in valueMap) {
