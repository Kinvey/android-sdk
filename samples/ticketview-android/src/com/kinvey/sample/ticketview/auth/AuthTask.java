 ...
 * @since 2.0
 */
abstract class AuthTask extends AsyncTask<String, Void, AuthResponse>
{
    ...
    public AuthTask(Activity activity, boolean refresh) {
        this(activity);
    ...
    protected AuthResponse doInBackground(String... params) {
        ...
        try {
            ...
            if (response.isSuccessStatusCode())
                return response.parseAs(AuthResponse.class);

        } catch (IOException e) {
            Log.e(TicketViewActivity.TAG, "failed to authenticate with auth link", e);
            ...
            if (response != null) {
                try {
                    ...
                    Log.e(TicketViewActivity.TAG, "failed to close response", e);
