...
public class AsyncUserStoreRequestManager<T extends User> extends AbstractAsyncUserStoreRequestManager<T> {
...
/**
    ...
    public AsyncUserStoreRequestManager(AbstractClient client, Class<T> userClass, KinveyAuthRequest.Builder builder) {
