 ...
 *
 *
 * This class is implemented as a singleton.  The instance can be accessed through OfflineStore.getInstance().
...
public class OfflineStore<T> {
    ...
    /**
     * The datastore maps an Entity's _id to an instance of an entity.  This represents the current local state of the Entity,
     * which can be synced.
     */
